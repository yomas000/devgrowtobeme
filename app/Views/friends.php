...
<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
  ...
  <li class="nav-item">
    <a class="nav-link" id="pills-pchat-tab" data-toggle="pill" href="#pills-pchat" role="tab" aria-controls="pills-pchat" aria-selected="false">Private Chats</a>
  </li>
</ul>
...
<div class="tab-content" id="pills-tabContent">
    ...
    <div class="tab-pane fade" id="pills-pchat" role="tabpanel" aria-labelledby="pills-pchat-tab">
    </div>
</div>
